...
print("Последний символ:", str_wth_8_char[-1])  # в данном случае отрицательный индекс подходит, так как нужно выбрать именно с конца символ
print("Третий с начала:", str_wth_8_char[2])    # строка не обязательно будет 8 символов как в данном случае
